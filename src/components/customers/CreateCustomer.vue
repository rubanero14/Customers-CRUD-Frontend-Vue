<template>
  ...
  <div class="col-6 col-md-4" v-if="!this.showRegistrationForm">
    <CPButton
      ...
      btnClass="toggle-btn-registration btn btn-outline-secondary mb-3"
  ...
  <div class="col-12 col-md-4" v-if="!this.showRegistrationForm">
    <CPButton
      btnClass="toggle-btn-registration btn btn-outline-primary mb-3"
      :disabled="this.$store.getters.isLoading"
          ...
          <form method="POST" @submit.prevent="registerNewCustomer">
            ...
            <div class="row">
              <div class="col-12">
                <CPButton
                  btnType="submit"
                  btnClass="btn btn-outline-success w-100 mb-2"
                  :disabled="this.$store.getters.isLoading"
                >
                  <SVG
                    :size="'sm'"
...
export default {
  ...
  data() {
    return {
      registrationEndPoint: this.$store.state.domain + "customers",
      firstName: "",
      lastName: "",
      age: "",
      mobileNo: "",
