<template>
  <center>
    <div class="col-12" v-if="!showRegistrationForm">
      ...
      >
        <SVG :size="'sm'"  :viewBox="'0 0 448 512'" :d="'M356.9 64.3H280l-56 88.6-48-88.6H0L224 448 448 64.3h-91.1zm-301.2 32h53.8L224 294.5 338.4 96.3h53.8L224 384.5 55.7 96.3z'" />
        ...
        <CardComponent>
          ...
          >
            ...
            <ToolTip :toolTipText="'Register New Customer'">
              <SVG :size="'lg'"  :viewBox="'0 0 640 512'" :d="'M352 128c0 70.7-57.3 128-128 128s-128-57.3-128-128S153.3 0 224 0s128 57.3 128 128zM0 482.3C0 383.8 79.8 304 178.3 304h91.4C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7H29.7C13.3 512 0 498.7 0 482.3zM504 312V248H440c-13.3 0-24-10.7-24-24s10.7-24 24-24h64V136c0-13.3 10.7-24 24-24s24 10.7 24 24v64h64c13.3 0 24 10.7 24 24s-10.7 24-24 24H552v64c0 13.3-10.7 24-24 24s-24-10.7-24-24z'" />
            </ToolTip>
          </div>
          <hr class="my-2" />
