                    ...
                    <CardComponent class="mb-3 me-0 me-lg-3" :style="{ '--i': index }">
                        <center :key="customer.id" :id="customer.id">
                            <div class="d-flex justify-content-between align-items-center text-secondary">
                                ...
                                <svg class="icon lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                    <path d="M272 304h-96C78.8 304 0 382.8 0 480c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32C448 382.8 369.2 304 272 304zM48.99 464C56.89 400.9 110.8 352 176 352h96c65.16 0 119.1 48.95 127 112H48.99zM224 256c70.69 0 128-57.31 128-128c0-70.69-57.31-128-128-128S96 57.31 96 128C96 198.7 153.3 256 224 256zM224 48c44.11 0 80 35.89 80 80c0 44.11-35.89 80-80 80S144 172.1 144 128C144 83.89 179.9 48 224 48z" />
                                </svg>
                            </div>
                            <hr class="my-2" />
                            <div>
                                <p class="text-secondary mb-1">Customer ID: <strong>{{customer.id}}</strong></p>
                                <p class="text-secondary mb-2">Customer Name: <strong>{{customer.firstName + ' ' + customer.lastName}}</strong></p>
                ...
                <CardComponent>
                    <center>
                        <div :id="customer.id" v-if="!isEditDetail">
                            <div class="d-flex justify-content-between align-items-center text-secondary">
                                <h5 class="text-secondary">{{this.isDelete ? 'Delete' : ''}} {{customer.firstName + ' ' + customer.lastName}}'s Details</h5>
                                <div>
                                    <svg class="icon lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" v-if="this.isDelete">
                                    ...
                                    <svg class="icon lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" v-else>
