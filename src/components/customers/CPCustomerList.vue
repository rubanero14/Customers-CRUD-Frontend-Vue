            ...
            <center :key="customer.id" :id="customer.id">
              ...
              >
                ...
                <ToolTip :toolTipText="customer.firstName + ' ' + customer.lastName + '\'s Profile'">
                    <SVG :size="'lg'" :viewBox="'0 0 448 512'" :d="'M272 304h-96C78.8 304 0 382.8 0 480c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32C448 382.8 369.2 304 272 304zM48.99 464C56.89 400.9 110.8 352 176 352h96c65.16 0 119.1 48.95 127 112H48.99zM224 256c70.69 0 128-57.31 128-128c0-70.69-57.31-128-128-128S96 57.31 96 128C96 198.7 153.3 256 224 256zM224 48c44.11 0 80 35.89 80 80c0 44.11-35.89 80-80 80S144 172.1 144 128C144 83.89 179.9 48 224 48z'"/>
                </ToolTip>
              </div>
              <hr class="my-2" />
              <div>
              ...
              >
                ...
                <div>
                  <ToolTip :toolTipText="'Delete ' + customer.firstName + ' ' + customer.lastName + '\'s Info'" v-if="this.isDelete">
                    <SVG :size="'lg'" :viewBox="'0 0 640 512'" :d="'M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2S-1.2 34.7 9.2 42.9l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L353.3 251.6C407.9 237 448 187.2 448 128C448 57.3 390.7 0 320 0C250.2 0 193.5 55.8 192 125.2L38.8 5.1zM264.3 304.3C170.5 309.4 96 387.2 96 482.3c0 16.4 13.3 29.7 29.7 29.7H514.3c3.9 0 7.6-.7 11-2.1l-261-205.6z'" />
                  </ToolTip>
                  <ToolTip :toolTipText="customer.firstName + ' ' + customer.lastName + '\'s Info'" v-else>
                    <SVG :size="'lg'" :viewBox="'0 0 512 512'" :d="'M256 512c141.4 0 256-114.6 256-256S397.4 0 256 0S0 114.6 0 256S114.6 512 256 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-144c-17.7 0-32-14.3-32-32s14.3-32 32-32s32 14.3 32 32s-14.3 32-32 32z'" />
                  </ToolTip>
                </div>
              </div>
              <hr class="my-2" />
